...
<li><a href = "events?from=2013-01-01&to=2013-01-15&lang=fr&format=json&offset=10&limit=5&token=<?php echo rand() ?>">Exemple d'accès au api events</a> : 5 évènements à partir du 10e, en français, entre le 01/01/2013 et le 15/01/2013, au format json</li>
<li><a href = "near?latitude=43.2964&longitude=5.37&distance=10&from=2012-01-01&to=2013-01-15&lang=fr&format=json&offset=10&limit=5&token=<?php echo rand() ?>">Exemple d'accès au api near</a> : 5 évènements situés dans un rayon de 10 Km autour du point de coordonnées 43.2964 et 5.37 (Marseille) à partir du 10e, en français, entre le 01/01/2012 et le 15/01/2013, au format json</li>
<li><a href = "event?id=13EVT027367&format=rdf&token=<?php echo rand() ?>">Accès à un événement à partir de son identifiant</a></li>
<li><a href = "id?format=rdf&token=<?php echo rand() ?>">Accès à la liste de tous les événements avec leurs identifiants</a></li>
</ul>
<hr>
